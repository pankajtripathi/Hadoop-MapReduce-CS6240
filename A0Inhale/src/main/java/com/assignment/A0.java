...
public class A0 {
	...
	String origin, destination,originCityName,destCityName,originStateAbr,destStateAbr,originStateName,
	destStateName, cancelled,carrier,price;
	...
	String  crsArrTime,crsDepTime,crsElapsedTime,arrTime,depTime,actualElapsedTime,arrDelay,
	arrDelayMinutes = null, arrDel15;
	public static int badData,goodData;
	TreeMap<String,List<Double>> map;
	public static Set<String> activeIn2015 = new TreeSet<>();
	List<Double> list;
	public static TreeMap<String,Double> avgPrice=new TreeMap<>();
	...
	/**
	 * @param field -> field to be checkd for being numeric
	 ...
	 * to get the number of baddata and goodata. It will write the input which is median or mean of a carrier on
	...
	public static void main(String args[]){
		...
		try{
			...
			for (Map.Entry<String,Double> entry:obj.avgPrice.entrySet()) {
